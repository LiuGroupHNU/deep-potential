...
class TestSIESTASinglePointEnergy:
    ...
    def test_cell(self) :
        ...
        for ii in range(len(cell)):
            self.assertAlmostEqual(self.system.data['cells'][0][ii], cell[ii])
    ...
    def test_coord(self) :
        ...
        for ii in range(len(coord)) :
            self.assertAlmostEqual(self.system.data['coords'][0][ii], float(coord[ii]))
    ...
    def test_force(self) :
        ...
        for ii in range(len(force)):
            self.assertAlmostEqual(self.system.data['forces'][0][ii], float(force[ii]))
    ...
    def test_viriale(self) :
        ...
        for ii in range(len(virial)):
            self.assertAlmostEqual(self.system.data['virials'][0][ii], float(virial[ii]))
