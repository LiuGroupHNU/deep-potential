...
def get_aiMD_frame(fname):
    ...
    return atom_names, atom_numbs, atom_types, np.array(cell), np.array(coord), np.array(energy), np.array(force), np.array(virial)

#atom_names, atom_numbs, atom_types, cell, coord, energy, force, virial = get_aiMD_frame('/home/smc/output')
#print(type(cell))
#print(cell[0])
#print(cell[1])
